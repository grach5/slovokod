      ...
      <main>
        ...
        <section className="ac-section">
          <div className="container">
            ...
            <div className="ac-grid cols-4" style={{marginTop: '1.5rem'}}>
              ...
              <div className="ac-card"><span className="ac-eyebrow">Свой темп</span><p>доступ ко всем дням тарифа открывается сразу — нет потоков, расписания и ожидания старта</p></div>
        ...
        <section className="ac-section">
          <div className="container">
            ...
            <ol className="ac-roadmap" style={{marginTop: '1.5rem'}}>
              <li><p>Выбираете тариф и пишете нам — коротко расскажем, что подходит именно вам.</p></li>
              <li><p>Договариваемся об оплате — доступ к материалам тарифа открывается сразу и целиком.</p></li>
              <li><p>Проходите дни в своём темпе, каждый день заканчивается самопроверкой.</p></li>
