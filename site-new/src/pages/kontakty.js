...
const FAQ = [
  ...
  {q: 'Формат — очно, онлайн или запись?', a: 'Гибрид: живые занятия онлайн (в Zoom) с преподавателем плюс материалы в записи для повторения. Ссылку на встречу пришлём при записи, точное расписание фиксируется тогда же.'},
